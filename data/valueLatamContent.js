...
export const navLinks = [
  ...
  ['#diferencial', 'Por qué nosotros'],
  ['#equipo', 'Equipo'],
  ['#trabaja', 'Referenciadores'],
];
...
export const solutions = [
  {
    ...
    text: 'Estructuración a través del mercado de capitales, avales SGR, leasing y programas de financiamiento productivo para optimizar capital de trabajo e inversión.',
    href: '#financiamiento',
  ...
  },
  {
    ...
    text: 'Administramos el capital de trabajo y la liquidez de tu empresa con las principales sociedades de bolsa. Y, por separado, gestionamos el portfolio personal de los socios.',
    href: '#liquidez',
  ...
  },
  {
    ...
    text: 'Armamos la infraestructura de cobros y pagos locales de tu empresa para que ahorres, más giros al exterior para tus proveedores.',
    href: '#medios',
  ...
  },
  {
    ...
    text: 'Diseñamos e implementamos agentes de IA que automatizan los procesos administrativos y de gestión de tu empresa: de la carga de datos al seguimiento de tareas y la generación de reportes. Menos tareas manuales, más capacidad operativa.',
    href: '#ia',
