...
export const metadata = {
  ...
  description: "Firma especializada en mercado de capitales y estructuración de financiamiento a través de agentes registrados. Consultoría financiera estratégica para empresas con ejecución end-to-end.",
};
