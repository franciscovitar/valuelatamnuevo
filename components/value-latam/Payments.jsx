  ...
  return (
    <section className="medios" id="medios">
      <div className="wrap">
        ...
        <div className="pay-hero reveal"><p>Hoy tus cobros y pagos te cuestan: Mercado Pago y otras PSP te cobran comisiones; el banco, impuestos. Nosotros armamos la infraestructura para que tu empresa opere hacia <b>costo cero</b>, combinando la <b>cuenta comitente</b> del mercado de capitales con una <b>nueva PSP</b>. Una sola cuenta para <b>cobrar, pagar, transferir, dar tarjetas a tu equipo e invertir</b> el excedente. La dejamos lista para operar; tu equipo solo la usa.</p></div>
        ...
        <div className="fin-cta reveal"><a className="btn btn-primary" href="#contacto">Quiero apuntar al costo 0 en mis pagos</a></div>
      </div>
    </section>
  );
}
