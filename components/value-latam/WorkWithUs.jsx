  ...
  return (
    <section className="finan" id="trabaja">
      <div className="wrap">
        ...
        <div className="fin-cta reveal"><a className="btn btn-primary" href="#contacto">Quiero ser referenciador</a><p className="note" style={{ marginTop: 14 }}>→ Te contactamos para evaluar tu perfil y armar el esquema de trabajo</p></div>
      </div>
    </section>
  );
}
