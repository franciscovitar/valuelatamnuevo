  ...
  return (
    <section className="ai" id="ia">
      <div className="wrap">
        ...
        <div className="ai-band reveal"><p className="tagline">Tu equipo deja de cargar datos. <b>Empieza a tomar decisiones.</b></p><a className="btn btn-primary" href="#contacto">Quiero automatizar mis procesos</a></div>
      </div>
    </section>
  );
}
