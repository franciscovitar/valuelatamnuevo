  ...
  return (
    <section className="cta" id="contacto">
      <div className="wrap cta-grid">
        ...
        <form noValidate>
          <div className="field"><label htmlFor="n">Nombre *</label><input id="n" name="nombre" autoComplete="name" required /></div>
          <div className="row2">
            <div className="field"><label htmlFor="e">Email *</label><input id="e" name="email" type="email" autoComplete="email" required /></div>
            <div className="field"><label htmlFor="t">Teléfono *</label><input id="t" name="telefono" type="tel" autoComplete="tel" required /></div>
          </div>
          <div className="field"><label htmlFor="emp">Empresa *</label><input id="emp" name="empresa" autoComplete="organization" required /></div>
          ...
          <div className="field"><label htmlFor="m">Mensaje (opcional)</label><textarea id="m" name="mensaje" /></div>
